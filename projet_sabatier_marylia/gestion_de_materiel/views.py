...
def accueil(request):
    return render(request, 'gestion_de_materiel/accueil.html')

"""enseignant"""
def liste_enseignants(request):
    enseignants = Enseignant.objects.all()
    return render(request, 'gestion_de_materiel/enseignant/liste_enseignants.html', {'enseignants': enseignants})
...
def ajout_enseignant(request):
    if request.method == 'POST':
        ...
        form = EnseignantForm()
    return render(request, 'gestion_de_materiel/enseignant/ajout_enseignant.html', {'form': form})
...
def liste_materiels_possedes(request, enseignant_id):
    ...
    return render(request, 'gestion_de_materiel/enseignant/liste_materiels_possedes.html', context)
...
def liste_materiels_proprietaire(request, enseignant_id):
    ...
    return render(request, 'gestion_de_materiel/enseignant/liste_materiels_proprietaire.html', context)
...
def liste_salles(request):
    ...
    return render(request, 'gestion_de_materiel/salle/liste_salles.html', {'salles': salles})

def liste_materiels_salle(request, salle_id):
    salle = get_object_or_404(Salle, id=salle_id)
    materiels = Materiel.objects.filter(lieu=salle)
    return render(request, 'gestion_de_materiel/salle/liste_materiels_salle.html', {'salle': salle, 'materiels': materiels})
...
def ajout_salle(request):
    if request.method == 'POST':
        ...
        form = SalleForm()
    return render(request, 'gestion_de_materiel/salle/ajout_salle.html', {'form': form})
...
def liste_materiels(request):
    ...
    return render(request, 'gestion_de_materiel/materiel/liste_materiels.html', {'materiels': materiels})
...
def ajout_materiel(request):
    ...
    return render(request, 'gestion_de_materiel/materiel/ajout_materiel.html',
...
def liste_accessoires(request, materiel_id):
    ...
    return render(request, 'gestion_de_materiel/materiel/accessoire/liste_accessoires.html', {'materiel': materiel, 'accessoires': accessoires})
...
def modifier_accessoire(request, materiel_id, accessoire_id):
    ...
    return render(request, 'gestion_de_materiel/materiel/accessoire/modifier_accessoire.html', {'form': form, 'materiel': materiel})
...
def ajouter_accessoire_via_materiel(request, materiel_id):
    ...
    return render(request, 'gestion_de_materiel/materiel/accessoire/ajout_accessoire_via_materiel.html', {'materiel': materiel, 'form': form})

"""transfert"""
from django.shortcuts import render, redirect
from gestion_de_materiel.models import Materiel
...
def choix_materiel(request):
    ...
    return render(request, 'gestion_de_materiel/transfert/choix_materiel.html', {
        'materiels': materiels,
...
def ajout_transfert(request, materiel_id):
    ...
    return render(request, 'gestion_de_materiel/transfert/ajout_transfert.html', {
        'form': form,
        'materiel': materiel,
...
def liste_historique_transferts(request, materiel_id):
    ...
    return render(request, 'gestion_de_materiel/transfert/liste_historique_transferts.html', {
        'materiel': materiel,
...
def afficher_transfert(request, materiel_id, transfert_id):
    ...
    return render(request, 'gestion_de_materiel/transfert/afficher_transfert.html', {
        'materiel': materiel,
        'transfert': transfert,
